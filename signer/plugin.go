...
// KeySpecFromPlugin retrieves and validates the key specification from a
// plugin by calling DescribeKey. It enforces that the plugin's response
// references the same keyID that was requested.
